...
export default function Cart() {
  ...
  return (
    <div 
      ...
      style={{ backgroundImage: "url('/backgrounds/Background image for cart section.jpeg')" }}
    >
      <div className="absolute inset-0 bg-white/70 backdrop-blur-[2px]"></div>
      <div className="relative z-10 flex flex-col flex-1">
        <header className="flex items-center justify-between mb-6">
          <div className="flex items-center">
            <button onClick={() => navigate(-1)} className="p-2 -ml-2 text-textDark hover:bg-white/50 rounded-full transition-colors">
        ...
        {items.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center pt-24 pb-32">
            <div className="w-48 h-48 bg-white/50 rounded-full flex items-center justify-center mb-8 relative">
          ...
          <>
              ...
              <AnimatePresence>
                {items.map((item) => (
                  <motion.div 
                    ...
                    className="bg-white/90 backdrop-blur-md rounded-2xl p-3 border border-white flex items-center shadow-sm"
                  >
                    ...
                    <div className="ml-3 flex-1 flex flex-col justify-center">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center bg-white/50 rounded-lg border border-white overflow-hidden">
                          <button 
              ...
              <div className="flex space-x-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white/80 border border-white rounded-xl py-3 pl-9 pr-4 text-sm text-textDark focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary uppercase placeholder:normal-case"
            ...
            {/* Summary */}
            <div className="bg-white/90 backdrop-blur-md rounded-3xl p-5 border border-white shadow-sm mb-6">
