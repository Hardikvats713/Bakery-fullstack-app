    ...
    <div className="p-6">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-white border border-borderSoft rounded-2xl py-3 pl-11 pr-4 text-sm text-textDark focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all shadow-sm"
          value={search}
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 rounded-2xl whitespace-nowrap transition-all duration-200 ${
                activeCategory === cat.name 
                  ...
                  : 'bg-white text-textMid border border-borderSoft hover:bg-softPink/50'
              }`}
            >
